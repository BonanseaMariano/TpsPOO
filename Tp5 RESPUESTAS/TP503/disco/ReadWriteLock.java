...
public class ReadWriteLock {
  ...
  /**
   * Adquiere el bloqueo de lectura. Si hay escritores o solicitudes de escritura, el hilo actual
   * espera hasta que sea seguro proceder.
   *
  ...
  /**
   * Adquiere el bloqueo de escritura. Si hay lectores o escritores, el hilo actual espera hasta que
   * sea seguro proceder.
   *
   * @throws InterruptedException si el hilo actual es interrumpido mientras espera.
   */
