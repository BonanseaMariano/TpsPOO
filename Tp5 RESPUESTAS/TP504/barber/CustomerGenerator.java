...
public class CustomerGenerator implements Runnable {
     ...
     * A cada cliente se le asigna un nombre único basado en el ID del hilo y se introduce un tiempo de espera aleatorio
     * entre la generación de cada cliente para simular llegadas de clientes en tiempo real.
     */
    @Override
    public void run() {
        while (true) {
            ...
            try {
                // Dormir por un tiempo aleatorio entre 0 a 10 segundos para simular el tiempo de llegada del cliente
