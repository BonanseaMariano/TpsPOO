...
public class Caja implements Runnable {
  ...
  /**
   * Método que ejecuta el hilo de la caja. Recupera clientes de la cola de la caja, simula el
   * tiempo de atención y los pasa a la cola (Buffer) de atención.
   */
  @Override
  public void run() {
    Cliente cliente;
    try {
      while ((cliente = colaCaja.get())
          != null) { // Mientras haya clientes en la cola de la caja (el poll no retorne null)
