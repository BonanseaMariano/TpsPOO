...
public class Cola implements Buffer {
   ...
   *
   * @return el cliente de la cola, o null si el tiempo de espera especificado transcurre antes de
   *     que haya un elemento disponible
   * @throws InterruptedException si es interrumpido mientras espera
   */
  public Cliente get() throws InterruptedException {
    return buffer.poll(
        20000,
        TimeUnit.MILLISECONDS); // Retorna null si no hay elementos en 20 segundos y es lo que
    // identifica el fin de la ejecución
  }
}
