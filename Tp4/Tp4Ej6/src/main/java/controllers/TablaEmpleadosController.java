...
public class TablaEmpleadosController implements Initializable {
  ...
  @FXML private TableColumn<Empleado, String> documentoColumn;

  @FXML private TableColumn<Empleado, Date> fechaNacimientoColumn;
  ...
  public void initialize(URL location, ResourceBundle resources) {
    ...
    Callback<TableColumn<Empleado, Void>, TableCell<Empleado, Void>> cellFactory =
        new Callback<>() {
          @Override
          public TableCell<Empleado, Void> call(final TableColumn<Empleado, Void> param) {
            final TableCell<Empleado, Void> cell =
                new TableCell<>() {
