    ...
    public void run() {
        while (true) {
            try {
                ...
                System.out.println("Taxi " + id + " llevando pasajero. Tiempo de viaje: " + travelTime + " minutos.");
                TimeUnit.MINUTES.sleep(travelTime);

                // Simula el tiempo de regreso vacío
                System.out.println("Taxi " + id + " regresando vacío. Tiempo de regreso: " + travelTime + " minutos.");
                TimeUnit.MINUTES.sleep(travelTime);
