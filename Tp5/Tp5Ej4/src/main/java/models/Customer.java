...
/**
 * Represents a customer in the barber shop simulation. Each customer has a unique ID and a
...
public class Customer implements Runnable {
  ...
  /** The run method for the customer thread. The customer attempts to enter the barber shop. */
  @Override
  public void run() {
    try {
      shop.enterShop(this);
