...
class BarberShop {
  ...
  /**
   * Allows a customer to enter the shop and wait for a haircut. If no chairs are available, the
   * customer leaves.
   *
  ...
  /**
   * The barber cuts the hair of the next waiting customer. If no customers are waiting, the barber
   * waits.
   *
   * @throws InterruptedException if the thread is interrupted while waiting
   */
